"""
Django settings for regularExpressions project.
...
SECRET_KEY = '2#bsd-$9fz*0^z%eia=n(0s9f83l3t+e-il6k^ggz#fd=hcoxr'
...
ROOT_URLCONF = 'regularExpressions.urls'
...
WSGI_APPLICATION = 'regularExpressions.wsgi.application'
